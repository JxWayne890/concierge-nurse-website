...
export default function ServiceAgreement() {
  return (
    <ResourceLayout title="How to Write a Concierge Nursing Service Agreement" description="Create a professional service agreement for your concierge nursing business covering scope of services, pricing, liability, HIPAA compliance, and termination policies." canonical="https://www.conciergenursebusiness.com/resources/templates/concierge-nursing-service-agreement" schema={articleSchema} category="Templates" categorySlug="/resources" lastUpdated="April 2026" headings={headings} relatedResources={relatedResources} cta={{ title: 'Protect Your Practice', description: 'Get the business frameworks to build a professionally structured concierge nursing practice.', buttonText: 'Start Here', buttonLink: '/start-here' }} faqSchema={faqSchema}>
      <QuickAnswer>
