...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long do I need a concierge nurse after cesarean section (C-section)?",
    ...
    {
      "@type": "Question",
      "name": "What does a concierge nurse do after cesarean section (C-section)?",
    ...
    {
      "@type": "Question",
      "name": "Is a concierge nurse covered by insurance after cesarean section (C-section)?",
    ...
    {
      "@type": "Question",
      "name": "How much does a concierge nurse cost after cesarean section (C-section)?",
...
export default function CSection() {
  return (
    <ResourceLayout
      title="Concierge Nursing Care After C-Section"
      description="How concierge nurses support new mothers recovering from C-section surgery with incision care, pain management, breastfeeding support, and newborn care assistance."
      canonical="/resources/procedures/concierge-nursing-after-c-section"
      category="Procedures"
    ...
    >
      <QuickAnswer>
        <p>
          Concierge nursing care after cesarean section (C-section) provides professional, in-home nursing support during the critical recovery period. Your concierge nurse monitors your surgical sites, manages pain, watches for complications, assists with mobility, and communicates with your surgeon — all in the comfort of your home. Recovery time is typically 6 to 8 weeks for full recovery, with significant improvement by 2 to 3 weeks.
        </p>
      </QuickAnswer>
      ...
      <section className="bg-cream border border-cream-dark p-8 mt-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-heading text-lg font-semibold text-navy mb-2">How long do I need a concierge nurse after cesarean section (C-section)?</h3>
