...
const relatedResources = [
  ...
  },
  {
    ...
    description: "Learn how concierge nurses support liposuction recovery with drain management, compression garment c...",
    link: "/resources/procedures/concierge-nursing-after-liposuction",
    category: 'Procedures',
  },
];
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long do I need a concierge nurse after cosmetic eye surgery (blepharoplasty — upper and/or lower eyelid surgery)?",
    ...
    {
      "@type": "Question",
      "name": "What does a concierge nurse do after cosmetic eye surgery (blepharoplasty — upper and/or lower eyelid surgery)?",
    ...
    {
      "@type": "Question",
      "name": "Is a concierge nurse covered by insurance after cosmetic eye surgery (blepharoplasty — upper and/or lower eyelid surgery)?",
    ...
    {
      "@type": "Question",
      "name": "How much does a concierge nurse cost after cosmetic eye surgery (blepharoplasty — upper and/or lower eyelid surgery)?",
...
export default function CosmeticEyeSurgery() {
  return (
    <ResourceLayout
      title="Concierge Nursing Care After Cosmetic Eye Surgery"
      description="Guide to concierge nursing care after blepharoplasty and cosmetic eye procedures, including cold compress management, vision monitoring, and activity restriction education."
      canonical="/resources/procedures/concierge-nursing-after-cosmetic-eye-surgery"
      category="Procedures"
    ...
    >
      <QuickAnswer>
        <p>
          Concierge nursing care after cosmetic eye surgery (blepharoplasty — upper and/or lower eyelid surgery) provides professional, in-home nursing support during the critical recovery period. Your concierge nurse monitors your surgical sites, manages pain, watches for complications, assists with mobility, and communicates with your surgeon — all in the comfort of your home. Recovery time is typically 1 to 2 weeks for initial recovery, with bruising and swelling resolving over 2 to 4 weeks.
        </p>
      </QuickAnswer>
      ...
      <section className="bg-cream border border-cream-dark p-8 mt-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-heading text-lg font-semibold text-navy mb-2">How long do I need a concierge nurse after cosmetic eye surgery (blepharoplasty — upper and/or lower eyelid surgery)?</h3>
