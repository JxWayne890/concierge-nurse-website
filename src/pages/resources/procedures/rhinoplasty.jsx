...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long do I need a concierge nurse after rhinoplasty (nose surgery)?",
    ...
    {
      "@type": "Question",
      "name": "What does a concierge nurse do after rhinoplasty (nose surgery)?",
    ...
    {
      "@type": "Question",
      "name": "Is a concierge nurse covered by insurance after rhinoplasty (nose surgery)?",
    ...
    {
      "@type": "Question",
      "name": "How much does a concierge nurse cost after rhinoplasty (nose surgery)?",
...
export default function Rhinoplasty() {
  return (
    <ResourceLayout
      ...
      description="Learn what concierge nursing care looks like after rhinoplasty, including what to expect during recovery, common complications to watch for, and how a private nurse supports optimal healing."
      canonical="/resources/procedures/concierge-nursing-after-rhinoplasty"
      category="Procedures"
    ...
    >
      <QuickAnswer>
        <p>
          Concierge nursing care after rhinoplasty (nose surgery) provides professional, in-home nursing support during the critical recovery period. Your concierge nurse monitors your surgical sites, manages pain, watches for complications, assists with mobility, and communicates with your surgeon — all in the comfort of your home. Recovery time is typically 1 to 2 weeks for initial recovery, with full results visible at 6 to 12 months.
        </p>
      </QuickAnswer>
      ...
      <section className="bg-cream border border-cream-dark p-8 mt-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-heading text-lg font-semibold text-navy mb-2">How long do I need a concierge nurse after rhinoplasty (nose surgery)?</h3>
