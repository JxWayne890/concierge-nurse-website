...
export default function IntakeForm() {
  return (
    <ResourceLayout title="How to Build a Concierge Nursing Intake Form" description="Create a comprehensive intake form for your concierge nursing practice that collects essential health information while providing a professional client experience." canonical="https://www.conciergenursebusiness.com/resources/templates/concierge-nursing-intake-form" schema={articleSchema} category="Templates" categorySlug="/resources" lastUpdated="April 2026" headings={headings} relatedResources={relatedResources} cta={{ title: 'Build Your Client Onboarding System', description: 'Get the templates and tools to create a professional client intake experience.', buttonText: 'Start Here', buttonLink: '/start-here' }} faqSchema={faqSchema}>
      <QuickAnswer>
