...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long do I need a concierge nurse after hair transplant (FUE or FUT technique)?",
    ...
    {
      "@type": "Question",
      "name": "What does a concierge nurse do after hair transplant (FUE or FUT technique)?",
    ...
    {
      "@type": "Question",
      "name": "Is a concierge nurse covered by insurance after hair transplant (FUE or FUT technique)?",
    ...
    {
      "@type": "Question",
      "name": "How much does a concierge nurse cost after hair transplant (FUE or FUT technique)?",
...
export default function HairTransplant() {
  return (
    <ResourceLayout
      title="Concierge Nursing Care After Hair Transplant"
      description="How concierge nurses support hair transplant recovery with graft site care, donor site management, sleeping position guidance, and complication monitoring."
      canonical="/resources/procedures/concierge-nursing-after-hair-transplant"
      category="Procedures"
    ...
    >
      <QuickAnswer>
        <p>
          Concierge nursing care after hair transplant (FUE or FUT technique) provides professional, in-home nursing support during the critical recovery period. Your concierge nurse monitors your surgical sites, manages pain, watches for complications, assists with mobility, and communicates with your surgeon — all in the comfort of your home. Recovery time is typically 7 to 14 days for initial healing, with transplanted hair growth visible at 3 to 6 months.
        </p>
      </QuickAnswer>
      ...
      <section className="bg-cream border border-cream-dark p-8 mt-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-heading text-lg font-semibold text-navy mb-2">How long do I need a concierge nurse after hair transplant (FUE or FUT technique)?</h3>
