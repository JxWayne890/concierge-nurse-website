...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long do I need a concierge nurse after breast augmentation?",
    ...
    {
      "@type": "Question",
      "name": "What does a concierge nurse do after breast augmentation?",
    ...
    {
      "@type": "Question",
      "name": "Is a concierge nurse covered by insurance after breast augmentation?",
    ...
    {
      "@type": "Question",
      "name": "How much does a concierge nurse cost after breast augmentation?",
...
export default function BreastAugmentation() {
  return (
    <ResourceLayout
      ...
      description="Understand what concierge nursing care involves after breast augmentation surgery, including recovery support, drain management, complication monitoring, and how private nursing improves outcomes."
      canonical="/resources/procedures/concierge-nursing-after-breast-augmentation"
      category="Procedures"
    ...
    >
      <QuickAnswer>
        <p>
          Concierge nursing care after breast augmentation provides professional, in-home nursing support during the critical recovery period. Your concierge nurse monitors your surgical sites, manages pain, watches for complications, assists with mobility, and communicates with your surgeon — all in the comfort of your home. Recovery time is typically 1 to 2 weeks for initial recovery, with activity restrictions for 4 to 6 weeks.
        </p>
      </QuickAnswer>
      ...
      <section className="bg-cream border border-cream-dark p-8 mt-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-heading text-lg font-semibold text-navy mb-2">How long do I need a concierge nurse after breast augmentation?</h3>
