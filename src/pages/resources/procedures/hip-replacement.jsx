...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long do I need a concierge nurse after total hip replacement (arthroplasty)?",
    ...
    {
      "@type": "Question",
      "name": "What does a concierge nurse do after total hip replacement (arthroplasty)?",
    ...
    {
      "@type": "Question",
      "name": "Is a concierge nurse covered by insurance after total hip replacement (arthroplasty)?",
    ...
    {
      "@type": "Question",
      "name": "How much does a concierge nurse cost after total hip replacement (arthroplasty)?",
...
export default function HipReplacement() {
  return (
    <ResourceLayout
      title="Concierge Nursing Care After Hip Replacement"
      description="Guide to concierge nursing care after hip replacement, including hip precautions, wound care, DVT prevention, fall prevention, and coordination with physical therapy."
      canonical="/resources/procedures/concierge-nursing-after-hip-replacement"
      category="Procedures"
    ...
    >
      <QuickAnswer>
        <p>
          Concierge nursing care after total hip replacement (arthroplasty) provides professional, in-home nursing support during the critical recovery period. Your concierge nurse monitors your surgical sites, manages pain, watches for complications, assists with mobility, and communicates with your surgeon — all in the comfort of your home. Recovery time is typically 6 to 12 weeks for major milestones, with continued improvement for 6 months to a year.
        </p>
      </QuickAnswer>
      ...
      <section className="bg-cream border border-cream-dark p-8 mt-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-heading text-lg font-semibold text-navy mb-2">How long do I need a concierge nurse after total hip replacement (arthroplasty)?</h3>
