...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long do I need a concierge nurse after bariatric surgery (gastric bypass, sleeve gastrectomy, or lap band)?",
    ...
    {
      "@type": "Question",
      "name": "What does a concierge nurse do after bariatric surgery (gastric bypass, sleeve gastrectomy, or lap band)?",
    ...
    {
      "@type": "Question",
      "name": "Is a concierge nurse covered by insurance after bariatric surgery (gastric bypass, sleeve gastrectomy, or lap band)?",
    ...
    {
      "@type": "Question",
      "name": "How much does a concierge nurse cost after bariatric surgery (gastric bypass, sleeve gastrectomy, or lap band)?",
...
export default function BariatricSurgery() {
  return (
    <ResourceLayout
      title="Concierge Nursing Care After Bariatric Surgery"
      description="Learn how concierge nurses support bariatric surgery recovery with nutrition monitoring, wound care, hydration management, and complication detection."
      canonical="/resources/procedures/concierge-nursing-after-bariatric-surgery"
      category="Procedures"
    ...
    >
      <QuickAnswer>
        <p>
          Concierge nursing care after bariatric surgery (gastric bypass, sleeve gastrectomy, or lap band) provides professional, in-home nursing support during the critical recovery period. Your concierge nurse monitors your surgical sites, manages pain, watches for complications, assists with mobility, and communicates with your surgeon — all in the comfort of your home. Recovery time is typically 2 to 4 weeks for initial surgical recovery, with dietary progression over 6 to 8 weeks.
        </p>
      </QuickAnswer>
      ...
      <section className="bg-cream border border-cream-dark p-8 mt-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-heading text-lg font-semibold text-navy mb-2">How long do I need a concierge nurse after bariatric surgery (gastric bypass, sleeve gastrectomy, or lap band)?</h3>
