...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long do I need a concierge nurse after total knee replacement (arthroplasty)?",
    ...
    {
      "@type": "Question",
      "name": "What does a concierge nurse do after total knee replacement (arthroplasty)?",
    ...
    {
      "@type": "Question",
      "name": "Is a concierge nurse covered by insurance after total knee replacement (arthroplasty)?",
    ...
    {
      "@type": "Question",
      "name": "How much does a concierge nurse cost after total knee replacement (arthroplasty)?",
...
export default function KneeReplacement() {
  return (
    <ResourceLayout
      title="Concierge Nursing Care After Knee Replacement"
      description="How concierge nurses support knee replacement recovery at home, including wound care, pain management, mobility assistance, DVT prevention, and physical therapy coordination."
      canonical="/resources/procedures/concierge-nursing-after-knee-replacement"
      category="Procedures"
    ...
    >
      <QuickAnswer>
        <p>
          Concierge nursing care after total knee replacement (arthroplasty) provides professional, in-home nursing support during the critical recovery period. Your concierge nurse monitors your surgical sites, manages pain, watches for complications, assists with mobility, and communicates with your surgeon — all in the comfort of your home. Recovery time is typically 6 to 12 weeks for major recovery milestones, with continued improvement for up to a year.
        </p>
      </QuickAnswer>
      ...
      <section className="bg-cream border border-cream-dark p-8 mt-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-heading text-lg font-semibold text-navy mb-2">How long do I need a concierge nurse after total knee replacement (arthroplasty)?</h3>
