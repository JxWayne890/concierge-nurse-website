...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long do I need a concierge nurse after dental surgery (wisdom teeth extraction, dental implants, or jaw surgery)?",
    ...
    {
      "@type": "Question",
      "name": "What does a concierge nurse do after dental surgery (wisdom teeth extraction, dental implants, or jaw surgery)?",
    ...
    {
      "@type": "Question",
      "name": "Is a concierge nurse covered by insurance after dental surgery (wisdom teeth extraction, dental implants, or jaw surgery)?",
    ...
    {
      "@type": "Question",
      "name": "How much does a concierge nurse cost after dental surgery (wisdom teeth extraction, dental implants, or jaw surgery)?",
...
export default function DentalSurgery() {
  return (
    <ResourceLayout
      title="Concierge Nursing Care After Dental Surgery"
      description="How concierge nurses support recovery after dental surgery including wisdom teeth extraction, dental implants, and jaw surgery with bleeding management, nutrition support, and pain control."
      canonical="/resources/procedures/concierge-nursing-after-dental-surgery"
      category="Procedures"
    ...
    >
      <QuickAnswer>
        <p>
          Concierge nursing care after dental surgery (wisdom teeth extraction, dental implants, or jaw surgery) provides professional, in-home nursing support during the critical recovery period. Your concierge nurse monitors your surgical sites, manages pain, watches for complications, assists with mobility, and communicates with your surgeon — all in the comfort of your home. Recovery time is typically 3 to 7 days for minor dental surgery, 4 to 8 weeks for jaw surgery.
        </p>
      </QuickAnswer>
      ...
      <section className="bg-cream border border-cream-dark p-8 mt-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-heading text-lg font-semibold text-navy mb-2">How long do I need a concierge nurse after dental surgery (wisdom teeth extraction, dental implants, or jaw surgery)?</h3>
