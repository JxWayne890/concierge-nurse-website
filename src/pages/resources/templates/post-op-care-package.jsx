...
export default function PostOpCarePackage() {
  return (
    <ResourceLayout title="How to Create a Post-Op Recovery Care Package" description="Step-by-step guide to building a professional post-operative recovery care package for your concierge nursing business, including structure, pricing, and presentation." canonical="https://www.conciergenursebusiness.com/resources/templates/post-op-recovery-care-package" schema={articleSchema} category="Templates" categorySlug="/resources" lastUpdated="April 2026" headings={headings} relatedResources={relatedResources} cta={{ title: 'Build Your Service Packages', description: 'Get the templates and guidance to create professional care packages for your concierge nursing business.', buttonText: 'Start Here', buttonLink: '/start-here' }} faqSchema={faqSchema}>
      <QuickAnswer>
