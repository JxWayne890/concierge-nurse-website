...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long do I need a concierge nurse after spinal surgery (laminectomy, spinal fusion, discectomy, or other spinal procedures)?",
    ...
    {
      "@type": "Question",
      "name": "What does a concierge nurse do after spinal surgery (laminectomy, spinal fusion, discectomy, or other spinal procedures)?",
    ...
    {
      "@type": "Question",
      "name": "Is a concierge nurse covered by insurance after spinal surgery (laminectomy, spinal fusion, discectomy, or other spinal procedures)?",
    ...
    {
      "@type": "Question",
      "name": "How much does a concierge nurse cost after spinal surgery (laminectomy, spinal fusion, discectomy, or other spinal procedures)?",
...
export default function SpinalSurgery() {
  return (
    <ResourceLayout
      title="Concierge Nursing Care After Spinal Surgery"
      description="Comprehensive guide to concierge nursing care after spinal surgery, including log-roll technique, pain management, mobility assistance, wound care, and complication monitoring."
      canonical="/resources/procedures/concierge-nursing-after-spinal-surgery"
      category="Procedures"
    ...
    >
      <QuickAnswer>
        <p>
          Concierge nursing care after spinal surgery (laminectomy, spinal fusion, discectomy, or other spinal procedures) provides professional, in-home nursing support during the critical recovery period. Your concierge nurse monitors your surgical sites, manages pain, watches for complications, assists with mobility, and communicates with your surgeon — all in the comfort of your home. Recovery time is typically 4 to 6 weeks for initial recovery, with fusion procedures requiring 3 to 6 months for full bone healing.
        </p>
      </QuickAnswer>
      ...
      <section className="bg-cream border border-cream-dark p-8 mt-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-heading text-lg font-semibold text-navy mb-2">How long do I need a concierge nurse after spinal surgery (laminectomy, spinal fusion, discectomy, or other spinal procedures)?</h3>
