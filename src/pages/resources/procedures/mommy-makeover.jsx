...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long do I need a concierge nurse after mommy makeover (typically combining abdominoplasty, breast procedure, and liposuction)?",
    ...
    {
      "@type": "Question",
      "name": "What does a concierge nurse do after mommy makeover (typically combining abdominoplasty, breast procedure, and liposuction)?",
    ...
    {
      "@type": "Question",
      "name": "Is a concierge nurse covered by insurance after mommy makeover (typically combining abdominoplasty, breast procedure, and liposuction)?",
    ...
    {
      "@type": "Question",
      "name": "How much does a concierge nurse cost after mommy makeover (typically combining abdominoplasty, breast procedure, and liposuction)?",
...
export default function MommyMakeover() {
  return (
    <ResourceLayout
      ...
      description="Comprehensive guide to concierge nursing care after a mommy makeover, covering multi-procedure recovery management, drain care, mobility assistance, and at-home nursing support."
      canonical="/resources/procedures/concierge-nursing-after-mommy-makeover"
      category="Procedures"
    ...
    >
      <QuickAnswer>
        <p>
          Concierge nursing care after mommy makeover (typically combining abdominoplasty, breast procedure, and liposuction) provides professional, in-home nursing support during the critical recovery period. Your concierge nurse monitors your surgical sites, manages pain, watches for complications, assists with mobility, and communicates with your surgeon — all in the comfort of your home. Recovery time is typically 2 to 4 weeks for initial recovery, with full activity resumption at 6 to 8 weeks.
        </p>
      </QuickAnswer>
      ...
      <section className="bg-cream border border-cream-dark p-8 mt-12">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="font-heading text-lg font-semibold text-navy mb-2">How long do I need a concierge nurse after mommy makeover (typically combining abdominoplasty, breast procedure, and liposuction)?</h3>
