...
export default function ChronicCarePlan() {
  return (
    <ResourceLayout title="How to Create a Chronic Care Management Plan" description="Build a structured chronic care management plan for your concierge nursing patients with this guide covering assessment protocols, goal setting, and care coordination." canonical="https://www.conciergenursebusiness.com/resources/templates/chronic-care-management-plan" schema={articleSchema} category="Templates" categorySlug="/resources" lastUpdated="April 2026" headings={headings} relatedResources={relatedResources} cta={{ title: 'Build Your Chronic Care Practice', description: 'Get the frameworks to create professional care plans for chronic disease patients.', buttonText: 'Start Here', buttonLink: '/start-here' }} faqSchema={faqSchema}>
      <QuickAnswer>
